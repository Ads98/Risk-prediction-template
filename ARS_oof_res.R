source(file.path("/well/doherty/users/rii148/risk_scores/",'ARS_eval_utils_try_catch.R'), echo = T)

source(file.path("/well/doherty/users/rii148/risk_scores/",'reclass.R'), echo = T)

# store <- paste0('gp_models/cv/split0/',model,'/score_hc_lin/')
# 
split <- 3
load(file=paste0('/well/doherty/users/rii148/risk_scores/ARS/ukb_ars_fp_split',split,'.RData'))
age_interact <- TRUE
...
full_res <-load_results(paste0('/well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/stacked/full/',store,'/')) #" array.  /well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/full/imp.  '/well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/full/array/'
cond_res <-load_results(paste0('/well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/stacked/condensed/',store,'/')) # array. "/well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/condensed/imp .  '/well/doherty/users/rii148/risk_scores/ARS/bs_imp/con/6y/condensed/array/'
...
imp_model <- readRDS(paste0("/well/doherty/users/rii148/risk_scores/stacked/array_job/",store,"/imp_model.rds"))
imp_test  <- readRDS( paste0("/well/doherty/users/rii148/risk_scores/stacked/array_job/",store,"/imp_model.rds"))
...
for (i in 1:5) {
  imputed_datasets[[i]] <- read.csv(paste0("/well/doherty/users/rii148/risk_scores/stacked/array_job/",model,"/full_models/","org_imp_",i,".csv"))#/well/doherty/users/rii148/risk_scores/array_job/full_models/","org_imp_",i,".csv". con/
}
...
full_models <- load_modles(path  = paste0('/well/doherty/users/rii148/risk_scores/stacked/array_job/',store,'/full_models/')) #/well/doherty/users/rii148/risk_scores/ARS/org_imp/con/ /well/doherty/users/rii148/risk_scores/array_job/full_models/
cond_models <- load_modles(path  = paste0('/well/doherty/users/rii148/risk_scores/stacked/array_job/',store,'/condensed_models/'),suffix = '_cond') # /well/doherty/users/rii148/risk_scores/array_job/condensed_models/
...
save.image(file=paste0('/well/doherty/users/rii148/risk_scores/ARS/cv_res/qrisk_split',split,'_ars_fp.RData'))
...
png("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/nb_curve/ARS/score/test/ovr_nb.png", type="cairo")  
...
png('/gpfs3/well/doherty/users/rii148/risk_scores/validation/ecg_reclass_age5.png',type = 'cairo',width=1400, height=400)
count_reclass_score(df_val,base = 'q',pred = 'rs_full',lab = 'macce.incident',th = 10,res_path = "/well/doherty/users/rii148/risk_scores/validation/qrisk/",name = "reclass_scores.png")
count_reclass(df_val,base = 'qrisk3',pred = 'ars',lab = 'macce.incident',th = 10,res_path = "/well/doherty/users/rii148/risk_scores/validation/qrisk/",name = "reclass_q_ars.png")
dev.off()
...
source(file.path("/well/doherty/users/rii148/risk_scores",'cal_plot_imp.R'), echo = T)
#config
...
cal_curve(df_val[val_cond,],male_q,rows_with_na,lab = 'macce.incident', pred_event_prob = 'qrisk3',xmin =0,xmax = 20,hist_max = 5000,title = "Male QRISK3 calibration hc",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/cv/split0/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)
cal_curve(df_val[val_cond,],male_ars,rows_with_na,lab = 'macce.incident', pred_event_prob = 'ars',xmin =0,xmax = 20,hist_max = 5000,title = "Male ARS calibration gc",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/cv/split0/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)

cal_curve(df_val[!val_cond,],female_q,rows_with_na,lab = 'macce.incident', pred_event_prob = 'qrisk3',xmin =0,xmax = 20,hist_max = 5000,title = "Female QRISK3 calibration hc",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/cv/split0/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)
cal_curve(df_val[!val_cond,],female_ars,rows_with_na,lab = 'macce.incident', pred_event_prob = 'ars',xmin =0,xmax = 20,hist_max = 5000,title = "Female ARS calibration hc",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/cv/split0/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)



cal_curve(df_val[val_cond,,],male_q_con,rows_with_na_con,lab = 'macce.incident', pred_event_prob = 'qrisk3_con',xmin =0,xmax = 20,hist_max = 5000,title = "Male QRISK3 Condensed calibration hc",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)
cal_curve(df_val[val_cond,,],male_ars_con,rows_with_na_con,lab = 'macce.incident', pred_event_prob = 'ars_con',xmin =0,xmax = 20,hist_max = 5000,title = "Male ARS Condensed calibratio hcn",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/val/",model,'/'),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)
...
cal_curve(df,female_ars_bs,lab = 'macce.incident', pred_event_prob = c('qrisk3','ars_con','ars'),xmin =0,xmax = 20,hist_max = 8000,title = "Risk score calibration",store_path = paste0("/gpfs3/well/doherty/users/rii148/risk_scores/ARS/cal_curves/imp_6y/bhf/"),met_path = paste0('/gpfs3/well/doherty/users/rii148/ecg_scores/macce_res/minb_set/comb/q_ecg/lin_res/mets/'),offset = 2.5)
...
source(file.path("/well/doherty/users/rii148/plot_scripts/",'unpaired_t.R'), echo = T)
source(file.path("/well/doherty/users/rii148/ecg_scores/",'boot_strap_res.R'), echo = T)
source(file.path("/well/doherty/users/rii148/plot_scripts/",'unpaired_t.R'), echo = T)
...
png('/gpfs3/well/doherty/users/rii148/ecg_scores/nb_diff.png',type = 'cairo',width=1400, height=400)
hist(bootstrap$t)
dev.off()
...
save.image(file='/well/doherty/users/rii148/risk_scores/ARS/cv_res/ars_val_eval.RData')
...
show_diff <- function(df,met,offset,org_df,rs,offset_base = 0,rs_base = 'ukbb_q',lp_base = NULL,lp_comp = NULL,digits = 3,test = 'greater'){
  ...
  png('/gpfs3/well/doherty/users/rii148/delta_nb.png',type = 'cairo',width=1400, height=400)
  hist(diff,breaks = 20)
  dev.off()
  png('/gpfs3/well/doherty/users/rii148/delta_h0.png',type = 'cairo',width=1400, height=400)
