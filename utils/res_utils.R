...
get_optimism <- function(mods,rows_with_na){
  ...
  bs_mods <- mods[[2]]
  print("org mods")
  print(length(org_mods))
  print(length(org_mods[[3]]))

  print(length(org_mods[[3]][[1]]))
  ...
  print('female dim')
  print(dim(female_q_cbl))
  print('m dim 2')
  print(dim(sapply(org_mods[[2]], function(df) df[,met])))
  print('m dim 2')
  print(dim(sapply(org_mods[[3]], function(df) df[,met])))
  print(org_mods[[3]][[1]][1:5,1])
  female_q_cbl <-rowMeans(female_q_cbl)
